...
<body>
	...
	<div class="container">
		<div class="row">
			<h1>Módulo de búsqueda de activos</h1>
			<label>A continuación filtre por los siguientes campos:</label>
		</div>
	</div>

	<div class="container">
		<c:url var="buscarAction" value="/activo/buscar"></c:url>
		<form:form action="${buscarAction}" commandName="activo">
			<table class="table table-bordered table-condensed table-stripped">
				<tr>
					...
					<td><form:input path="serial" cssClass="form-control" /></td>
				</tr>
			</table>
		...
		<c:if test="${fn:length(listActivos) == 0}">
			<label><font color="">No se encontraron resultados con el criterio de búsqueda.</font></label>
		</c:if>
	</div>
</body>
